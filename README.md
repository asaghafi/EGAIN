# EGAIN
Abolfazl Saghafi, Soodeh Moallemian, Miray Budak, and Rutvik Deshpande, EGAIN: Enhanced Generative Adversarial Networks for Imputing Missing Values, _Computers, Materials & Continua (CMC)_, 82(2), 94, 2026. [DOI: 10.32604/cmc.2026.082996](https://doi.org/10.32604/cmc.2026.082996)
...
```
Alternatively, you can install EGAIN and its requirements directly from this github page. This option works great if you are using google collaboratory: 
```python
## Clone EGAIN 
